...
Relay currently uses one model extraction call plus deterministic retrieval, policy and a durable Jira worker. The worker is not an AI agent. This document is a proposal, not implemented functionality.
